...
import { DEMO_PRODUCTS, DEMO_REVIEWS } from '../data/demoProducts';
  ...
  useEffect(() => {
    const fetchProductAndReviews = async () => {
      ...
      try {
        ...
        console.warn('Supabase fetch failed, loading demo specs:', err.message);
        setDbError(err.message);
        const fallbackProd = DEMO_PRODUCTS.find(p => p.id === id) || DEMO_PRODUCTS[0];
